            ...
            child: Column(
              children: [
                ...
                Align(
                  ...
                  child: Text('Choose your avatar', style: Theme.of(context).textTheme.titleMedium),
                ),
                      ...
                      InkWell(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: _avatarIndex == i
                                ? [
                                    BoxShadow(
                                      color: _avatars[i].color.withOpacity(0.35),
                                      blurRadius: 14,
                                      spreadRadius: 2,
                                    )
                                  ]
